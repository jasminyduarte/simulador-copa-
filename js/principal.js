...
function tabela1() {
    ...
    if (gol_rus > gol_ara) {
        ...
        verifica(this.ponto_rus,this.ponto_ara,this.ponto_uru,this.ponto_egi);
    }
    //++++++ ARA GANHA ***
    if (gol_rus < gol_ara) {
        //rus
...
function verifica (rus,ara,uru,egi){

  if(rus>ara || rus>uru || rus>egi){
  ...
  if (ara >rus || ara>uru || ara >egi){
      
    return $("#ara").css({
        'color': 'blue'
    });
  }
  if(uru>rus || uru > ara || uru >egi){
    
    return $("#uru").css({
        'color': 'blue'
    });
  }
  if(egi>rus || egi >ara || egi> uru){
    return $("#egi").css({
        'color': 'blue'
    });
  }
